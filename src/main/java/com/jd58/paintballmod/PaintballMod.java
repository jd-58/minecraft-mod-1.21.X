...
import com.jd58.paintballmod.item.ModCreativeModeTabs;
...
@Mod(PaintballMod.MOD_ID)
public class PaintballMod
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "jdpaintballmod";
    ...
    public PaintballMod(IEventBus modEventBus, ModContainer modContainer)
    {
